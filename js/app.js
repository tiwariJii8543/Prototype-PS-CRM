...
Object.assign(translations.en, {
    ...
    footerBadgeCitizen: 'Citizen First',
    footerBadgeTransparency: 'Transparent Workflow',
    footerQuickTitle: 'Quick Access',
    footerHelpdeskTitle: 'Citizen Helpdesk',
    footerSupportHours: 'Support Hours: 9:00 AM - 6:00 PM',
    footerHelpdeskNote: 'Digital Helpdesk & Escalation Support',
    footerServiceTitle: 'Service Information',
    footerService1: 'Complaint registration with tracking ID',
    footerService2: 'Department response with proof upload',
    footerService3: 'Citizen verification and public accountability',
    footerService4: 'Admin analytics, SLA review, and audit visibility',
    footerBottomLeft: '© 2026 Smart PS-CRM. All rights reserved.',
    footerBottomRight: 'Designed for transparent public grievance redressal.'
});
...
Object.assign(translations.hi, {
    ...
    quickTrack: 'स्थिति देखें',
    quickPublic: 'सभी शिकायतें देखें',
...
function applyTranslations(language) {
    ...
    const textMap = {
        ...
        'footer-brand-title': 'footerBrandTitle',
        'footer-brand-blurb': 'footerBrandBlurb',
        'footer-badge-portal': 'footerBadgePortal',
        'footer-badge-citizen': 'footerBadgeCitizen',
        'footer-badge-transparency': 'footerBadgeTransparency',
        'footer-quick-title': 'footerQuickTitle',
        'footer-link-home': 'navHome',
        'footer-link-submit': 'navSubmitComplaint',
        'footer-link-track': 'navTrackComplaint',
        'footer-link-public': 'navPublicPortal',
        'footer-link-map': 'navMapView',
        'footer-helpdesk-title': 'footerHelpdeskTitle',
        'footer-support-hours': 'footerSupportHours',
        'footer-helpdesk-note': 'footerHelpdeskNote',
        'footer-service-title': 'footerServiceTitle',
        'footer-service-1': 'footerService1',
        'footer-service-2': 'footerService2',
        'footer-service-3': 'footerService3',
        'footer-service-4': 'footerService4',
        'footer-bottom-left': 'footerBottomLeft',
        'footer-bottom-right': 'footerBottomRight'
    };
